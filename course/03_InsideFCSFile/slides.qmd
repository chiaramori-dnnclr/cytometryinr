...
:::: fragment
::: {.callout-tip title="."}
Having survived our charge into the unknown, the four parameter slots appear to be "varMetadata", "data", "dimLabels" and ".\_classVersion\_".
:::
::::
...
:::: fragment
::: {.callout-tip title="."}
Continuing on to the last slot ".\_\_classVersion\_\_"
:::
::::
